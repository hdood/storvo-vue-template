<template>
  <Head>
    ...
    <meta
      name="description"
      content="Welcome to my e-commerce store. Find the best products here!"
    />
  </Head>
  <div>
    <div
      class="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md"
      v-for="product in newArrivals.data"
    >
      <a href="#">
        <img
          class="rounded-t-lg object-cover"
          :src="product?.media?.[0].large_url"
          alt="product image"
        />
      </a>
      <span
      ...
      <div class="mt-4 px-5 pb-5">
        <a href="#">
          <h5 class="text-xl font-semibold tracking-tight text-slate-900">
            {{ parseText(product.attribute_data.name) }}
          </h5>
        </a>
...
import type { Collection, PaginationResponse, Product } from '@/types'
import parseText from '@/utils/parseText'
import { Head } from '@inertiajs/vue3'

defineProps<{
  newArrivals: PaginationResponse<Product>
  sale: PaginationResponse<Product>
  featured: PaginationResponse<Product>
